...
for (uint32_t u = 0; u < ueNodes.GetN (); ++u)
  ...
  sumoClient->SetAttribute ("SumoConfigPath", StringValue ("src/traci/examples/RandomTrips/sim.sumocfg"));
...
// callback function for node creation
  ...
  //----------------------------------------------------------------------------------------------------------------------
  AnimationInterface anim ("src/traci-applications/examples/lena_sumo.xml"); // Mandatory
